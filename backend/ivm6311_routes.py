...
from common_routes import IVM6311_demo_slaves,write_into_slaves,allowed_file, get_state_base
...
def get_state():
    ...
    if device:
        ...
        message,alldevices_state, ivm_state = get_state_base(device=device)
